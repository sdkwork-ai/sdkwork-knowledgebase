...
impl KnowledgeApi {
    ...
    pub async fn spaces_members_list(&self, space_id: &str, cursor: Option<&str>, page_size: Option<i64>) -> Result<KnowledgeSpaceMemberPage, SdkworkError> {
        let query = build_query_string(&[
            QueryParameterSpec::new("cursor", cursor, "form", true, false, None),
            QueryParameterSpec::new("page_size", page_size, "form", true, false, None),
        ]);
