...
- Application key: `sdkwork-knowledgebase-harmony-mobile`
- Bundle name: `com.sdkwork.knowledgebase.mobile`
...
SDK consumer work loads `../../../sdkwork-specs/APP_SDK_INTEGRATION_SPEC.md` and runs `check-app-sdk-consumer-imports.mjs`. API work loads `../../../sdkwork-specs/API_SPEC.md` and its validators. List/search work loads `../../../sdkwork-specs/PAGINATION_SPEC.md`. Source configuration work loads `../../../sdkwork-specs/SOURCE_CONFIG_SPEC.md`. Locale resource work loads `../../../sdkwork-specs/I18N_SPEC.md`.
